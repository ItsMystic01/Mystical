...
public class Configuration {
    ...
    private Double defaultCoins;
    public String getDefaultRank() { return defaultRank; }
    public Double getDefaultCoins() { return defaultCoins; }
    public void setDefaultRank(String defaultRank) { this.defaultRank = defaultRank; }
    public void setDefaultCoins(Double defaultCoins) { this.defaultCoins = defaultCoins; }
}
